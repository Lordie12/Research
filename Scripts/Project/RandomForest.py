...
from Evaluation import begin_evaluation
...
permute_train_test = True
TrainSize = 75
HoldoutSize = 36
###############################################

# Cross-validation on several tests
nTests = 1
###################################
...
for c in range(nTests):
    ...
    print '--------------------------------------------------------------'
    for i in testTypes:
        # Cosine features are included by default in FinalTrain.csv last column
